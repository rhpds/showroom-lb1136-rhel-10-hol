...
Go to the RHEL Web Console from your browser and log in. Select the Machines tab.  You will notice that the interface is pretty rudimentary compared with a modern virtualization manager like OpenShift Virtualization, but one critical feature is available: the console.
