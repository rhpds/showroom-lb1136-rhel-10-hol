...
5e223c5d8e71  registry.access.redhat.com/ubi10/ubi:latest  cat /proc/sys/ker...  4 seconds ago  Exited (0) 4 seconds ago              trusting_hugle
----
...
2: eth0@if29: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP group default qlen 1000
    link/ether 3e:cd:b0:5b:14:1a brd ff:ff:ff:ff:ff:ff link-netnsid 0
    inet 10.88.0.14/16 brd 10.88.255.255 scope global eth0
       valid_lft forever preferred_lft forever
    inet6 fe80::3ccd:b0ff:fe5b:141a/64 scope link tentative proto kernel_ll 
       valid_lft forever preferred_lft forever
----
...
10.88.0.15      347606728bb8 gifted_poitras
----
...
tmpfs           1.4G   16M  1.4G   2% /etc/hosts
shm              63M     0   63M   0% /dev/shm
/dev/vda3        50G  4.2G   46G   9% /usr/bin
devtmpfs        4.0M     0  4.0M   0% /proc/keys
----
...
registry.access.redhat.com/ubi10/ubi       latest      8ba11fcef4ef  6 weeks ago             212 MB
----
