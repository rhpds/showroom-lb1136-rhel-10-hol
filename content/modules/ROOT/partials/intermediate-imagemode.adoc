...
Now let's build the QCOW vm image into which we well install our custom
Image Mode/bootc container.  Note that an Image Mode container can also
be built to be installed onto a physical server as well.
