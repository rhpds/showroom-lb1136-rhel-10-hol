...
[{format_cmd}]
----
cat /usr/local/etc/sample-fedora-bootc.ocifile
----

[{format_plain}]
----
FROM quay.io/fedora/fedora-bootc@sha256:769911834d6895930c25ad0cb9e6d56a8f0abcb4bc6355a48b79c4fabc2b595d
...
[{format_cmd}]
----
podman build --file /usr/local/etc/sample-fedora-bootc.ocifile --tag localhost/custom-bootc
----
...
podman run --rm --privileged \
  ...
  quay.io/centos-bootc/bootc-image-builder@sha256:6d1f93399d067f49ae178b6ef2affc69e235c26158eec22022d211deefd6a5ea \
  --type qcow2 \
  --local \
  --rootfs ext4 \
