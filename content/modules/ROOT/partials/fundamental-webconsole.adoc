...
You can find more information:
    ...
    * link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/managing_systems_in_the_rhel_web_console[Managing systems in the RHEL web console]
