...
Now execute the upgrade. This will install several rpms, make some repo and other configuration changes, and will take several minutes (6 to 10 in our vm testing).  
...
To finish the upgrade process, a reboot is now required.  Without console access you won't be able to see the final output and unfortunately this is the step that takes the longest. 
