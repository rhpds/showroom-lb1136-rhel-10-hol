...
NOTE: If you are a subscriber to Red Hat Enterprise Linux, you can pull authentic Red Hat certified images directly from Red Hat's repository.  For example: `podman pull rhel7.9 --creds 'username:password'`
...
stopped containers has also has grown.
