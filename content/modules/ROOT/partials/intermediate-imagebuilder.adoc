...
Meaning, with *Image Builder* you can design an OS blueprint and then specify the target platfrom to create the appropriate image (ie: VMWare, AWS, Openstack, KVM, etc...).
